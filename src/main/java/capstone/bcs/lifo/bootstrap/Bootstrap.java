...
//        while (rst.next()) {
//            Product productlist = new Product(rst.getInt("id"), rst.getString("product_cat"), rst.getString("product_name")
//                                            , rst.getDouble("product_price"), rst.getString("product_image")
//                                            , rst.getString("product_dimensions"), rst.getBlob("description1")
//                                            , rst.getBlob("description2"), rst.getBlob("description3"), rst.getBlob("description4")
//            );
